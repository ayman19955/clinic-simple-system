...
<div class="modal fade" id="createAppointment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة موعد</h1>
            ...
            <form action="{{ route('appointments.store') }}" method="POST">
                <div class="modal-body row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select class="form-control" name="practitioner_id" required>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="date" class="form-control text-start" name="appointment_date" required>
                    </div>

                    <!-- Appointment Time -->
                    <div class="mb-3 col-md-6">
                        <label for="appointment_time" class="form-label">وقت الموعد</label>
                        <input type="time" class="form-control text-start" name="appointment_time" required>
                    </div>
