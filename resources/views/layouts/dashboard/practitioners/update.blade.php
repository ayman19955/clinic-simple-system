<!-- Modal -->
<div class="modal fade" id="updatePractitioner" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form id="formUpdate" action="" method="POST">
                ...
                <div class="modal-body row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control text-start" name="email" id="email" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control text-start" name="experience_years" id="experience_years"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="availability_hours" class="form-label">ساعات التوفر</label>
                        <input type="text" class="form-control" name="availability_hours" id="availability_hours"
                            required placeholder="مثال: 9 AM - 5 PM">
                    </div>
                </div>
